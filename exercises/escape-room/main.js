...
function keyFunc (){
    ...
    keypad === "135" ? console.log("Jigsaw: Well well well, looks like you win this time!")
    :
    keypad != "135" ? (console.log("WRONG"), startOver())
    : 
...
function startOver (){
    ...
    const action = readline.question(sentence)
        ...
        action === "door" ? (console.log("You walk over to the door and try the handle, it's locked. It appears to need a three digit key to open."),startOver())
        :
